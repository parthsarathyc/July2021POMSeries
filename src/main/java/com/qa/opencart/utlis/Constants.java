...
public class Constants {
	...
	public static final CharSequence LOGIN_PAGE_URL_VALUE = "https://demo.opencart.com/index.php?route=account/login";
	
	public static final List<String> EXP_ACCOUNTS_SECTIONS_LIST = new ArrayList<String> (Arrays.asList("My Account", 
